...
1. **Set up your Schwab developer account and app:**
    ...
    2. Request access to the [Trader API - Individual](https://developer.schwab.com/products/trader-api--individual) API product.. 
    2. Make a new Schwab individual developer app in the [dashboard](https://developer.schwab.com/dashboard/apps) with callback URL `https://127.0.0.1`
    ...
    5. Enable TOS ([Thinkorswim](https://www.schwab.com/trading/thinkorswim)) for your Schwab account; it is needed for orders and other API calls. You can do this by logging into your Schwab account on a TOS platform.
2. **Install packages:**
...
3. **Start Coding** 
    ...
    4. Questions? Join the [Discord group](https://discord.gg/m7SSjr9rs9) or consult the documentation.
