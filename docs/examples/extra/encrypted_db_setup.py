...
time.sleep(5)
input(
    "Next, we will redo the authentication process to save the encrypted tokens. Press Enter to continue, or Ctrl+C to exit."
)
...
print(
    "You can now create new Client instances using the same encryption key to access the tokens."
)
print(
    "If you want to remove encryption, create a new Client without the encryption parameter and redo the authentication process."
)
